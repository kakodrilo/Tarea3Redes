  ...
  def _handle_PacketIn (self, event):
    ...
    if packet.dst.is_multicast:
      ...
      if packet.dst not in self.macToPort: # 4
        ...
        # si es un msg desde fuera de la red
